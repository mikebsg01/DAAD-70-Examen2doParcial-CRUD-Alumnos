            ...
            <div class="row">
              ...
              <form action="create.php" method="POST">
                ...
                <div class="input-field col s12 <?php echo ((isset($errors) and $errors->has('first_name')) ? 'input-error' : '') ?>">
                  <input type="text" name="student[first_name]" id="first_name" class="validate" required="required" <?php echo(! empty($studentRequest['first_name']) ? "value=\"{$studentRequest['first_name']}\"" : '')?>>
                ...
                <div class="input-field col s12 <?php echo ((isset($errors) and $errors->has('last_name')) ? 'input-error' : '') ?>">
                  <input type="text" name="student[last_name]" id="last_name" class="validate" required="required" <?php echo (! empty($studentRequest['last_name']) ? "value=\"{$studentRequest['last_name']}\"" : '')?>>
